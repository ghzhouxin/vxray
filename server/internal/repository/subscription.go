...
func (r *SubscriptionRepository) UpdateContentHash(id uint, contentHash string) error {
	return r.db.Model(&model.Subscription{}).Where("id = ?", id).Updates(map[string]any{
